  ...
  <div id="appManagePage">
    ...
    <a-form layout="inline" :model="searchParams" @finish="doSearch">
      ...
      <a-form-item label="生成类型">
        <a-select
          v-model:value="searchParams.cosType"
          placeholder="选择生成类型"
          style="width: 150px"
        >
    ...
    >
      <template #bodyCell="{ column, record }">
        ...
        <template v-else-if="column.dataIndex === 'cosType'">
          {{ formatcosType(record.cosType) }}
        </template>
...
import { CODE_GEN_TYPE_OPTIONS, formatcosType } from '@/utils/cosTypes'
